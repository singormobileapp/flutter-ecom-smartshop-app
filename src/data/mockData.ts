...
export const products: Product[] = [
  {
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1695048216129-87c6b5d27d54',
    ],
  ...
  },
  {
    ...
    price: 899,
    images: ['https://images.unsplash.com/photo-1610945415242-4b2269c7504a'],
    category: 'Electronics',
    rating: 4.6,
    reviewCount: 1834,
    inStock: true,
  ...
  },
  {
    ...
    price: 89,
    images: ['https://images.unsplash.com/photo-1595950653106-6090eeab606d'],
    category: 'Sports',
    rating: 4.3,
    reviewCount: 634,
    inStock: true,
